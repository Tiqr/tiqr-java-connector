...
- Add InterruptionLevel.TIME_SENSITIVE to APN message
...
- Enrollments can not be started for existing registrations
...
- Trow exception if lookups fail or authentications or registrations
